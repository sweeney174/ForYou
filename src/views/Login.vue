<template>
  <div id="app" style="height:100vh;width:100vw;">
    <div class="gift" :class="{ dukdik: !open }">
      <div :class="{ boxOpen: open,giftTop: !open }" @click="click"></div>
      <div v-if="open" @click="login">
        <h1 class="gift-text" >{{ text }}</h1>
        <i>
          <svg
            t="1607245256615"
            class="icon"
      ...
      <div :class="{ boxDown: open ,giftBox: !open}" @click="click"></div>
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      open: false,
      text: "Choose your style for your love",
    };
  },
  methods: {
    login:function(){
