<template>
  <div>
    <!-- <h2 class="packageheader">最后，为你的礼物加上包装</h2>
    <div class="container">
      <div class="gift dukdik editorsgift">
        <div class="giftTop"></div>
        <div>
          <i>
            <svg
              t="160724525615"
    ...
    <div id="ft">
      <div class="choosepackage pack1" @click="pack1"></div>
      <div class="choosepackage pack2" @click="pack2"></div>
      <div class="choosepackage pack3" @click="pack3"></div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods:{
    pack1(){
      sessionStorage.setItem('gift_box_link','https://foryou-store.oss-cn-shanghai.aliyuncs.com/pre_templates/gift_box/pack1.png')
      Toast('礼物包装成功~')
    },
    pack2(){
      sessionStorage.setItem('gift_box_link','https://foryou-store.oss-cn-shanghai.aliyuncs.com/pre_templates/gift_box/pack2.png')
      Toast('礼物包装成功~')
    },
    pack3(){
      sessionStorage.setItem('gift_box_link','https://foryou-store.oss-cn-shanghai.aliyuncs.com/pre_templates/gift_box/pack3.png')
      Toast('礼物包装成功~')
    },
  }
};
...
.pack1{
  background: url(https://foryou-store.oss-cn-shanghai.aliyuncs.com/pre_templates/gift_box/pack1.png) no-repeat;
  background-color: transparent;
  
}
.pack2{
  background: url(https://foryou-store.oss-cn-shanghai.aliyuncs.com/pre_templates/gift_box/pack2.png) no-repeat;
  background-color: transparent;
  overflow: hidden;
}
.pack3{
  background: url(https://foryou-store.oss-cn-shanghai.aliyuncs.com/pre_templates/gift_box/pack3.png) no-repeat;
  background-color: transparent;
}
</style>
